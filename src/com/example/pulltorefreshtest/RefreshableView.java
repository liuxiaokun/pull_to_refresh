...
public class RefreshableView extends LinearLayout implements OnTouchListener {
     ...
     * 下拉头的布局参数
     */
    private MarginLayoutParams headerMargin;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && !loadOnce) {
            ...
            headerMargin = (MarginLayoutParams) header.getLayoutParams();
            headerMargin.topMargin = hideHeaderHeight;
        ...
        if (ableToPull) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (currentStatus != STATUS_REFRESHING) {
                    if (headerMargin.topMargin > 0) {
                        currentStatus = STATUS_RELEASE_TO_REFRESH;
                    } else {
                        currentStatus = STATUS_PULL_TO_REFRESH;
                    }
                    // 通过偏移下拉头的topMargin值，来实现下拉效果
                    headerMargin.topMargin = (distance / 2)
                            + hideHeaderHeight;
                    header.setLayoutParams(headerMargin);
                }
                break;
    ...
    private void setIsAbleToPull(MotionEvent event) {
        ...
        if (firstChild != null) {
            ...
            if (firstVisiblePos == 0 && firstChild.getTop() == 0) {
                ...
                if (headerMargin.topMargin != hideHeaderHeight) {
                    headerMargin.topMargin = hideHeaderHeight;
                    header.setLayoutParams(headerMargin);
                }
                ableToPull = false;
    ...
    class RefreshingTask extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... params) {
            int topMargin = headerMargin.topMargin;
            while (true) {
        ...
        protected void onProgressUpdate(Integer... topMargin) {
            updateHeaderView();
            headerMargin.topMargin = topMargin[0];
            header.setLayoutParams(headerMargin);
        }
    ...
    class HideHeaderTask extends AsyncTask<Void, Integer, Integer> {
        ...
        protected void onPostExecute(Integer topMargin) {
            headerMargin.topMargin = topMargin;
            header.setLayoutParams(headerMargin);
            currentStatus = STATUS_REFRESH_FINISHED;
        }
    }
